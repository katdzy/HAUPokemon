class Monster {
  ...
  factory Monster.fromJson(Map<String, dynamic> json) {
    return Monster(
      ...
      spawnLatitude:
          double.tryParse(json['spawn_latitude'].toString()) ?? 0.0,
      spawnLongitude:
          double.tryParse(json['spawn_longitude'].toString()) ?? 0.0,
      spawnRadiusMeters:
          double.tryParse(json['spawn_radius_meters'].toString()) ?? 0.0,
