...
class _EditMonsterPageState extends State<EditMonsterPage> {
  ...
  void initState() {
    super.initState();
    _monsterNameController =
        TextEditingController(text: widget.monster.monsterName);
    _monsterTypeController =
        TextEditingController(text: widget.monster.monsterType);
  ...
  Future<void> _updateMonster() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        ...
        finalPictureUrl =
            await ApiService.uploadMonsterImage(_selectedImage!);
